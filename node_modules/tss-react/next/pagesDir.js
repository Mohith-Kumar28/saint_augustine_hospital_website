...
CacheProvider = react_1.CacheProvider) {
    ...
    function augmentDocumentWithEmotionCache(Document) {
        var _a, _b;
        const super_getInitialProps = (_b = (_a = Document.getInitialProps) === null || _a === void 0 ? void 0 : _a.bind(Document)) !== null && _b !== void 0 ? _b : document_1.default.getInitialProps.bind(document_1.default);
